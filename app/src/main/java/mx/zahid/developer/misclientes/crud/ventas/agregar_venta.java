...
public class agregar_venta extends AppCompatActivity{
    ...
    private Button add_venta;
    public DataBaseManager managerc;

    //UI REFERENCE
    private TextView fechaVentaTxt;
    private TextView costoVentaTxt;
    private TextView productoVentaTxt;
    ...
    private Spinner spinnerStatusVenta;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.agregar_venta);
        ...
        fechaVentaTxt = (TextView) findViewById(R.id.fechaVentaCliente);
        costoVentaTxt = (TextView) findViewById(R.id.txt_add_costoVentaCliente);
        productoVentaTxt = (TextView) findViewById(R.id.txt_add_nombreProductoClienteVenta);
        add_venta = (Button) findViewById(R.id.btn_add_pedidoCliente);
        cantidadVenta = (EditText) findViewById(R.id.txt_add_cantidadClienteVenta);

        InputMethodManager imm = (InputMethodManager)getSystemService(getApplicationContext().INPUT_METHOD_SERVICE);
        imm.hideSoftInputFromWindow(fechaVentaTxt.getWindowToken(), 0);
        /*LLENADO DE SPINNER
        * SE HIZO USO DE UNA ADAPTADOR*/
        spinnerStatusVenta = (Spinner) findViewById(R.id.spinner_select_estadoVentaCliente);
        ...
        spinnerStatusVenta.setAdapter(adaptadorEstados);
        //FINALIZA
        //ESCUCHAR AL ELEMENTO SELECCIONADO DEL SPINNER DE ESTADOS DE REPARACION
        spinnerStatusVenta.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
        ...
        fechaVentaTxt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog mDatePicker=new DatePickerDialog(agregar_venta.this, new DatePickerDialog.OnDateSetListener() {
                    public void onDateSet(DatePicker datepicker, int selectedyear, int selectedmonth, int selectedday) {
                        ...
                        fechaVentaTxt.setText(selectedyear + "-" + month  + "-" + dayG );
                    }
                },mYear, mMonth, mDay);
                mDatePicker.setTitle("Fecha de Venta");
                mDatePicker.show();  }
        });
        //FINALIZA
        ...
        try{
                ...
                if(Integer.parseInt(costoVentaTxt.getText().toString()) >= 0) {
                    //cantidad,fecha,detalles,id_cliente

                    Float cantidadToFloat = Float.parseFloat(costoVentaTxt.getText().toString());
                    String fechaVenta = fechaVentaTxt.getText().toString();
                    String detalleToString = productoVentaTxt.getText().toString();
                    Integer cantidadPedidotxt = Integer.parseInt(cantidadVenta.getText().toString());
                    Float totalPedido;
                    ...
                    managerc.insertarVenta(fechaVenta, detalleToString, estadoP, cantidadToFloat,Integer.parseInt(idcliente), totalPedido,cantidadPedidotxt);

                    Snackbar.make(v, "Venta agregada correctamente", Snackbar.LENGTH_LONG)
                            .setActionTextColor(Color.rgb(241, 196, 15))
                            .show();
                    agregar_venta.this.finish();
